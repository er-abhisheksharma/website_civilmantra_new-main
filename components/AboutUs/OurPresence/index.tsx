                ...
                <div className="w-full lg:w-1/2">
                    ...
                    <motion.div
                        ...
                        <ul className="list-disc marker:text-lg marker:text-primary text-justify space-y-2">
                            ...
                            <li><span className="text-primary">Regional Offices</span> -  Himachal Pradesh - 174305<span className=" text-2xl font-bold">,</span> S.A.S Nagar - Mohali<span className=" text-2xl font-bold">,</span> Itanagar 791111 Arunachal Pardesh<span className=" text-2xl font-bold">,</span> Rajouri Tehsil & District Rajouri U.T of J&K<span className=" text-2xl font-bold">,</span> Baramulla - J&K<span className=" text-2xl font-bold">,</span> Singpora Pattan - District Baramulla - J&K</li>
