...
const OurPresence = () => {
    return (
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
        {/* Presence Section - Image Carousel */}
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            <ul className="list-disc marker:text-lg marker:text-primary text-justify space-y-2">
              <li>
                <span className="text-primary">Registered Office</span> - 277 VPO, Hiran Kudna West Delhi 110041
              </li>
              <li>
                <span className="text-primary">Corporate Office</span> - 3rd Floor, Tower 3A, DLF CORPORATE GREENS,
                Sector 74A, Gurugram, Haryana 122004
              </li>
              <li>
                <span className="text-primary">Regional Offices</span> - Himachal Pradesh{" "}
                <span className=" text-2xl font-bold">,</span> S.A.S Nagar - Mohali
                <span className=" text-2xl font-bold">,</span> Itanagar - Arunachal Pardesh
                <span className=" text-2xl font-bold">,</span> Rajouri Tehsil & District Rajouri U.T of J&K
                <span className=" text-2xl font-bold">,</span> Baramulla - J&K
                <span className=" text-2xl font-bold">,</span> Singpora Pattan - District Baramulla - J&K
              </li>
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-lg md:text-xl font-bold mt-2 py-2"
          >
            Project Locations
          </motion.h2>
