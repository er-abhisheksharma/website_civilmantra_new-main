            ...
            <div className="text-justify mt-8 space-y-8  px-4 sm:px-2">
                <div>
                    ...
                    <p className="text-base md:text-[18px] leading-[28px] md:leading-[32px] mb-5 font-normal">
                        At CivilMantra, we understand the critical role that roads play in connecting communities, facilitating trade, and driving economic prosperity. Our team of skilled engineers and experienced project managers works collaboratively with clients to design, construct, and supervise the development of:
                    </p>
                </div>
                <div>
