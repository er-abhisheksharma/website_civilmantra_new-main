...
const Heroprojects = () => {
  return (
    <>
      <div className="relative z-20 flex flex-col justify-center items-center text-center mb-0 max-sm:px-4 text-white py-[40px] ">
        {/* Background Video */}
        <Image
        ...
        />
        <div className=" absolute top-[1px] left-0 w-full h-full bg-black opacity-80"></div>
